...
/// <summary>
/// Calculation status for success reporting
/// </summary>
...
/// <summary>
/// Extension methods for KnParameter to add success evaluation without modifying base class
/// </summary>
public static class ParameterSuccessExtensions
{
    // Dictionary to store success evaluators per parameter instance
    private static readonly Dictionary<string, Func<KnParameter, CalculationStatus>> _successEvaluators = new();

    /// <summary>
    /// Set a success evaluator for this parameter instance
    /// </summary>
    ...
    /// <summary>
    /// Evaluate success status for this parameter
    /// </summary>
    ...
    /// <summary>
    /// Check if this parameter has a success test defined
    /// </summary>
    public static bool HasSuccessTest(this KnParameter param)
    {
        if (param == null) return false;
        return _successEvaluators.ContainsKey(param.GetKnowId());
    }

    /// <summary>
    /// Helper to check if a parameter has a calculated value
    /// </summary>
