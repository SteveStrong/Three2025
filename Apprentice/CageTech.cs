...
public class Marker3D : FoText3D
{


    public Marker3D(string name, string color, Text3DAlign align) : base(name, color)
    {
        TextAlign = align;
...
public class CageTech : ICageTech
{
    ...
    public CageTech(IWorkspace space, IFoundryService foundry, IThreeDService render3d)
    {
        Workspace = space;
